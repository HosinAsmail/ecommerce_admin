...
INNER JOIN favorite ON favorite.favorite_productsid=productsview.products_id AND favorite.favorite_adminid='$userId' 
...
class StoreAllData {
  ...
  initializeDb({int newVersion = 1}) async {
    ...
    String path = join(dbPath, 'ecommerce_admin.db');
